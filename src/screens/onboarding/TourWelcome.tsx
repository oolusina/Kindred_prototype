...
export default function TourWelcome() {
  ...
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden bg-canvas">
      ...
      <div className="absolute left-1/2 top-1/2 z-50 flex w-[min(320px,calc(100%-32px))] -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-3 rounded-card-lg bg-white px-5 py-[22px] shadow-[0px_6px_24px_0px_rgba(0,0,0,0.18)]">
        ...
        <p className="w-full max-w-[280px] text-center font-sans text-[13px] leading-[1.36] text-ink-600">
