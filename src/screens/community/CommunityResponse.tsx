...
import bookmark from '../../assets/figma/learn-bookmark-border.svg'
    ...
    <div className="relative flex h-full min-h-0 w-full flex-col bg-canvas">
      ...
      <div className="flex shrink-0 items-center justify-between px-5 pt-2">
        <div className="flex items-center gap-2.5">
          ...
          <p className="font-serif text-[20px] font-medium text-ink">Answer</p>
        </div>
        <button
          type="button"
          aria-label="Save"
      ...
      <div className="app-scroll flex min-h-0 flex-1 flex-col gap-3.5 px-5 pt-4 pb-4">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex flex-col gap-0.5">
            <p className="font-sans text-[15px] font-medium text-ink">QuietHeron</p>
            <span className="flex w-fit items-center gap-0.5 rounded-full border border-accent bg-accent-50 py-0.5 pl-2 pr-1.5">
              <span className="font-sans text-[12px] text-accent">92% match</span>
        ...
        <div className="overflow-hidden rounded-[18px] border border-[#f0c519] bg-[#fefaed]">
          <div className="flex">
            ...
            <div className="flex flex-1 flex-col gap-2.5 px-4 py-2.5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <p className="pl-3.5 font-sans text-[13px] text-ink-500">
        ...
        >
          ...
          <span className="flex items-center gap-0.5">
            <span className="font-sans text-[12px] text-accent">See the evidence</span>
            <img src={chevronRight} alt="" className="size-[13px]" />
          </span>
        </button>

        <div className="flex items-start gap-2 rounded-xl border border-accent-200 bg-card px-3 py-2.5">
          <img src={info} alt="" className="mt-0.5 size-4 shrink-0" />
        ...
        <div className="h-px w-full bg-[#817e77]/40" />
        ...
        {REPLIES.map((r, i) => (
          <div key={r.name}>
            {i > 0 && <div className="mb-3.5 h-px w-[318px] max-w-full bg-accent-100" />}
            <div className="flex items-start gap-2.5">
              ...
              <div className="flex min-w-0 flex-1 flex-col gap-1">
                <div className="flex items-center gap-1">
                  <span className="font-sans text-[12px] text-ink">{r.name}</span>
                  <span className="font-sans text-[13px] text-ink-500">· {r.age}</span>
                </div>
                <p className="font-sans text-[15px] leading-[1.42] text-ink">{r.text}</p>
                <button type="button" className="cursor-pointer self-start font-sans text-[13px] text-ink-500">
                  Reply
                </button>
              </div>
            </div>
      ...
      <div className="flex shrink-0 flex-col gap-3 px-5 pb-2 pt-2">
        <button
          type="button"
          className="w-full cursor-pointer rounded-[14px] border border-accent-200 bg-card py-3.5 font-sans text-[15px] font-semibold text-accent"
        >
          Reply to this post
        </button>
        <button
