...
export default function PhoneFrame({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-dvh w-full bg-[#e9e5dd] sm:flex sm:items-center sm:justify-center sm:py-8">
      <div className="relative mx-auto flex h-dvh w-full flex-col overflow-hidden bg-canvas sm:h-[844px] sm:w-[390px] sm:rounded-[54px] sm:shadow-[0_24px_80px_rgba(31,26,23,0.35)] sm:ring-8 sm:ring-[#1c1917]">
        {children}
      </div>
